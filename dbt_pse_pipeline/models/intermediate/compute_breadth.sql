SELECT *,
	...
	ROUND(AVG(RSI120) OVER (PARTITION BY Date)          , 2) AS MarketRSI120,
	...
	ROUND(AVG(RSI120) OVER (PARTITION BY Date, Sector)  , 2) AS SectorRSI120,
	...
	ROUND(AVG(RSI120) OVER (PARTITION BY Date, Industry), 2) AS IndustryRSI120,
